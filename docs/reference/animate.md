...
> [!WARNING]
> Provided hast elements are sanitized before being inserted into DOM. See [sanitization schema](https://github.com/okdevme/BetterAnimations/blob/main/shared/animation/hastSanitizeSchema.js).
