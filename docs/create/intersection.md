...
> You may explore the [source code](https://github.com/okdevme/BetterAnimations/blob/main/shared/packs/preinstalled.pack.json) of a preinstalled pack to see more examples of Intersection handling.
